...
// We use the async keyword to make a function asynchronous, meaning it can handle operations that take time (like API calls, timers, file reading) without blocking the rest of the code.
...
await:--->
    ...
    makes async code look like synchronous code (clean & readable)
*/
