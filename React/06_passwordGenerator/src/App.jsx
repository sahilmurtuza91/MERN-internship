      ...
      <div className='w-full max-w-md mx-auto text-center shadow-md rounded-lg px-4 pb-4 my-8 text-orange-500 bg-gray-700'>
        ...
        <div className='flex shadow rounded-lg overflow-hidden  bg-white'>
          <input
            type="text"
            value={password}
            className='outline-none w-full py-3 mx-3' placeholder='Password'
            readOnly
            ref={passwordRef}
          />
          <button
            onClick={copyPasswordToClipbord}
            className='outline-none bg-blue-700 px-3 py-0.5 text-white shrink-0'>Copy</button>
        </div>
        <div className='flex text-sm gap-x-2'>
          <div className='flex items-center gep-x-1'>
            ...
            />
            <label >length: {length}</label> {/* This shows the current value of the slider next to it */}
          </div>
