...
function ManageSubAdmins() {
    ...
    const currentData = SubAdminsData.slice(startIndex, endIndex);
    const totalPages = Math.ceil(SubAdminsData.length / rowsPerPage);
        ...
        <Box >
            <Box sx={{ backgroundColor: "white", borderRadius: "10px", padding: 3, display: "flex", flexDirection: "column", width: "100%" }}>
                <Box sx={{ width: "100%", overflowX: "auto", mb: 2 }}>
                    ...
                    >
                        {!isLoading && SubAdminsData.length === 0 ? (
                            <Box
                                sx={{
                                    py: 5,
                                    textAlign: "center",
