...
function FamilySupportMembers() {
    const navigate = useNavigate();
    const indexData = [
        { index: "S.No", value: "id" },
        { index: "Name", value: "name" },
        { index: "Email", value: "email" },
        { index: "Relationship", value: "relationship" },
        { index: "Patient", value: "patientName" },
        { index: "Status", value: "status" },
        { index: "Access Level", value: "accessLevel" },
...
export default FamilySupportMembers