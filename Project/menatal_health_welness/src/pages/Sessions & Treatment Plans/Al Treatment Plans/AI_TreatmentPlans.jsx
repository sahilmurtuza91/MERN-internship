...
function AI_TreatmentPlans() {
    const navigate = useNavigate();
    const indexData = [
        { index: "S.No", value: "id" },
        { index: "Patient Name", value: "name" },
        { index: "Specialist", value: "email" },
        { index: "Generated Date", value: "relationship" },
        { index: "Type", value: "relationship" },
        { index: "AI Model", value: "patientName" },
        { index: "Confidence", value: "status" },
        ...
        <Box sx={{ px: 3, pt: 8, display: "flex", flexDirection: "column", gap: "25px" , minWidth:"1000px",}}>
            ...
            <Box sx={{ backgroundColor: "white", borderRadius: "10px", padding: 3, display: "flex", flexDirection: "column", width: "100%" }}>
                ...
                <Box sx={{ display: "flex", justifyContent: "end", gap:2 }}>
                    ...
                    >
                      <HotelClassIcon />  Schedule Session
                    </Button>
...
export default AI_TreatmentPlans