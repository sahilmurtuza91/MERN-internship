...
function MonitorProgress() {
    ...
    const indexData = [
        ...
        { index: "Last Session", value: "relationship" },
        { index: "Progress", value: "relationship" },
        { index: "Assessment", value: "patientName" },
        { index: "Adherence	", value: "status" },
        { index: "Status", value: "accessLevel" },
    ...
    const [activeStatus, setActiveStatus] = useState("On Track");
        ...
        <Box sx={{ px: 3, pt: 8, display: "flex", flexDirection: "column", gap: "25px" , minWidth:"1000px",}}>
            ...
            <Box sx={{ backgroundColor: "white", borderRadius: "10px", padding: 3, display: "flex", flexDirection: "column", width: "100%" }}>
                ...
                <Box sx={{ display: "flex", justifyContent: "end", gap:2 }}>
                    ...
                    >
                       <GetAppIcon /> Export Progress Report
                    </Button>
                </Box>

                <Box sx={{ display: "flex", gap: "10px", mb: "20px", pb: "5px" }}>
                    {["On Track", "Need Attention", "At Risk", "Completed"].map((status) => {
