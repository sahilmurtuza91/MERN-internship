...
import index from '../../UserManagement/ManageSubAdmins/Index';
function TreatmentPlans() {
    ...
    const indexData = [
        ...
        { index: "Start Date", value: "relationship" },
        { index: "End Date", value: "relationship" },
        { index: "Type", value: "patientName" },
        ...
        <Box sx={{ px: 3, pt: 8, display: "flex", flexDirection: "column", gap: "25px", minWidth: "1000px", }}>
            ...
            <Box sx={{ backgroundColor: "white", borderRadius: "10px", padding: 3, display: "flex", flexDirection: "column", width: "100%" }}>
                ...
                <Box sx={{ display: "flex", gap: "10px", mb: "20px", pb: "5px" }}>
                    {["Active", "Pending Approval", "Completed", "On Hold"].map((status) => {
